...
for ang in range(90, 101, 1):
    r_pan_front.angle = 180 - ang
    r_pan_mid.angle = ang
    r_pan_back.angle = 180 - ang
    l_pan_front.angle = 180 - ang
    l_pan_mid.angle = ang
    l_pan_back.angle = 180 - ang
    time.sleep(0.02)
print("lowering legs ")
for ang in range(120, 89, -1):
    # r_hip_front.angle = ang
    r_hip_mid.angle = ang
    # r_hip_back.angle = ang
    l_hip_front.angle = 180 - ang
